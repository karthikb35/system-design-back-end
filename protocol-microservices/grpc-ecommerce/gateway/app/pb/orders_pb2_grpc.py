...
class OrderServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.PlaceOrder = channel.unary_unary(
                ...
                request_serializer=orders__pb2.PlaceOrderRequest.SerializeToString,
        ...
        self.ListOrders = channel.unary_unary(
                ...
                response_deserializer=orders__pb2.ListOrdersReply.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PlaceOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.PlaceOrder,
                    request_deserializer=orders__pb2.PlaceOrderRequest.FromString,
            ...
            'ListOrders': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=orders__pb2.ListOrdersReply.SerializeToString,
            ),
    }
...
class OrderService:
    ...
    def PlaceOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/orders.OrderService/PlaceOrder',
            orders__pb2.PlaceOrderRequest.SerializeToString,
    ...
    def ListOrders(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/orders.OrderService/ListOrders',
            orders__pb2.ListOrdersRequest.SerializeToString,
            orders__pb2.ListOrdersReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

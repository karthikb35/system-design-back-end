...
The database topology is identical across all three protocol editions (REST,
gRPC, GraphQL) — the transport changes, the storage doesn't. See
[postgres/README.md](postgres/README.md) for the details.
